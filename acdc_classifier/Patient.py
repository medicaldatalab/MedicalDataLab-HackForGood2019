...
class Patient:
    ...
    def setPatology(self):
        if self.hasPatology():
            patology = self.infoDict['Group']
        else:
            patology = None
    ...
    def __init__(self, path, patient_id, weight=None, height=None, sys_volumes=None, dia_volumes=None, patology=None):
        self.path = path
        ...
        if patology == None:
            self.patology = self.setPatology()
        else:
